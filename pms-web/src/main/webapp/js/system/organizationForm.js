...
function insertRecord(){
	...
	$.ajax({
        url: common.getContextPath()+'/system/insertOrg.do',
        type: 'Post',
        dataType: "json",
        data:{
        	name:name,
...
function updateRecord(id){
	...
	$.ajax({
        url: common.getContextPath()+'/system/updateOrg.do',
        type: 'Post',
        dataType: "json",
        data:{
        	id:id,
