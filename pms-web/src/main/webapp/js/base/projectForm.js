...
function insertRecord(){
	...
	$.ajax({
        url: common.getContextPath()+'/base/insertProject.do',
        type: 'Post',
        dataType: "json",
        data:{
            name:name,
...
function updateRecord(id){
	...
	$.ajax({
        url: common.getContextPath()+'/base/updateProject.do',
        type: 'Post',
        dataType: "json",
        data:{
        	id:id,
