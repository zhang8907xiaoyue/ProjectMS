...
function insertRecord(){
	...
	$.ajax({
        url: common.getContextPath()+'/base/insertModular.do',
        type: 'Post',
        dataType: "json",
        data:{
            projectid:projectid,
...
function updateRecord(id){
	...
	$.ajax({
        url: common.getContextPath()+'/base/updateModular.do',
        type: 'Post',
        dataType: "json",
        data:{
        	id:id,
