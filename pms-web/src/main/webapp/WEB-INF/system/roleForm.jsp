...
<body style="padding: 20px">
					...
					<form id="roleForm" class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-xs-2 control-label no-padding-right" for="name">
								<font style="color:red">*</font>角色名称</label>
							<div class="col-xs-4">
					...
					<form id="roleForm" class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-xs-2 control-label no-padding-right" for="name">
								<font style="color:red">*</font>角色名称</label>
							<div class="col-xs-4">
								<input type="text" id="name" class="col-xs-10 col-xs-12" value="${role.name}" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-2 control-label no-padding-right" for="status">
							...
							<div class="col-xs-4" style="padding-top: 5px;">
								...
								<script type="text/javascript">
									$("input:radio[name=status][value='${role.status}']").attr("checked",true);
								</script>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-2 control-label no-padding-right" for="listid">
								<font style="color:red">*</font>排序</label>
							<div class="col-xs-4">
								<input type="text" id="listid" class="col-xs-10 col-xs-12" value="${role.listid}" />
							</div>
						</div>
						<input type="text" id="form-id" style="display: none" value="${role.id}">
					</form>
				</c:otherwise>
			</c:choose>
		</div>
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/js/system/roleForm.js?v=<%=Constant.VERSION%>"></script>
	<script type="text/javascript">
