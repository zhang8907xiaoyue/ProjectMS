...
<div class="row" style="padding: 10px 0px;">
	<div class="col-xs-12">
		<button id="release" type="button" class="btn btn-xs btn-pink">
			<i class="icon-leaf"></i> 代码发布
		</button>
	</div>
</div>
<div class="row">
					...
					for(int i=0;i<releaseList.size();i++){
					    %>
							<tr class="">
								...
								<td class="center">
									<label><input type="checkbox" name="cb-release" class="customer" link-project="<%=releaseList.get(i).getProject()%>" link-customer="<%=releaseList.get(i).getCustomerid()%>">&nbsp;
									<%=releaseList.get(i).getCustomername()%></label>
								</td>
								<td class="center">
									<%
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/js/release/torelease.js?v=<%=Constant.VERSION%>"></script>
</body>
</html>