		...
		<div class="col-xs-12">
			<form id="newForm" class="form-horizontal" role="form">
				<div class="form-group">
					<label class="col-xs-1 control-label no-padding-right" for="remark">
						<font style="color:red">*</font>备注</label>
					<div class="col-xs-10" id="textPosition">
						<textarea id="remark" rows="10" cols="20" class="form-control" style="width:100%"></textarea>
					</div>
...
<script type="text/javascript"
		src="<%=request.getContextPath()%>/js/task/suspendForm.js?v=<%=Constant.VERSION%>"></script>
