					...
					<form id="eidtForm" class="form-horizontal" role="form" style="padding: 20px">
						<div class="form-group">
							...
							<div class="col-xs-3">
								...
								<input id="input-employee" type="text" value="${contribution.employeeid}" style="display: none">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-1 control-label no-padding-right" for="title">
								<font style="color:red">*</font>标题</label>
							<div class="col-xs-10">
								<input type="text" id="title" class="col-xs-10" value="${contribution.title}"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-1 control-label no-padding-right" for="content">
								需求描述</label>
							<div class="col-xs-10">
								<textarea id="content" name="textarea" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;">${contribution.contenthtml}</textarea>

							</div>
						</div>

						<input type="text" id="form-id" style="display: none" value="${contribution.id}">
					</form>
				</c:when>
				<c:otherwise>
					<div class="zxy-title">
...
<script type="text/javascript"
		src="<%=request.getContextPath()%>/js/pa/contributionForm.js?v=<%=Constant.VERSION%>"></script>
